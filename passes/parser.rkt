...
(define python-parser
  (parser
   ...
   (tokens
    ...
    COND_KWS COND_OPS ARITH_OPS INDEX_OPS
    TYPE_KWS TYPE_OPS
    END
    )
   (grammar
    (Program ((Statements) (new-program #f $1))
             ((CHECKED Statements) (new-program #t $2))
             )
    ...
    (Assignment ((Assignment_lhs ASSIGN Expression) (assign $1 $3)))
    (Return_stmt ((RETURN) (return_void))
                 ((RETURN Expression) (return $2))
                 )
    (Global_stmt ((GLOBAL ID) (global $2)))
    (Function_def ((DEF ID LPAR Params RPAR Return_type Statements) (func $2 $4 $7 $6))
                  ((DEF ID PAR Return_type Statements) (func $2 (empty-param) $5 $4))
                  )
    (Params ((Param_with_default) (func_params $1 (empty-param)))
            ((Params COMMA Param_with_default) (func_params $3 $1))
            )
    (Param_with_default ((Assignment_lhs ASSIGN Expression) (with_default $1 $3)))
    ...
    (Assignment_lhs ((ID) (untyped-var $1))
